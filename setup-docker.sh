...
log_step() {
  # Сохраняем текущую позицию курсора и переходим на последнюю строку
  tput sc
  tput cup $(tput lines) 0

  # Очищаем строку, заполняя пробелами, и возвращаем курсор в начало строки
  printf "\033[K" # Очищаем строку
  printf "=====================================================\n"
  printf "%s\n" "$1"
  printf "====================================================="
